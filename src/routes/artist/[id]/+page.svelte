	...
	<div class="content">
		...
		{#if albums && albums.items.length > 0}
			<div class="section">
				<div class="section-title">
					<h2>Albums</h2>
					<Button element="a" href={`/artist/${artist.id}/albums`} variant="outlined"
		...
		{#if appearsOn && appearsOn.items.length > 0}
			<div class="section">
				<div class="section-title">
					<h2>Appears On</h2>
					<Button element="a" href={`/artist/${artist.id}/appears-on`} variant="outlined"
		...
		{#if relatedArtists && relatedArtists.artists.length > 0}
			<div class="section">
				<div class="section-title">
					...
					<Button element="a" href={`/artist/${artist.id}/related-artists`} variant="outlined"
